...
int main(int argc, char* argv[])
{
	...
	// Used for all hashes
	byte digest[LSH512_HASH_VAL_MAX_BYTE_LEN];
	...
	printf("Name: LSH-384\n");
	printf("Source: gen_lsh512.cpp, https://github.com/noloader/cryptopp-test\n");
	alg = LSH_TYPE_512_384;
	...
	for (size_t i=0; i<128; ++i)
	{
		...
		lsh_err err = lsh512_digest(alg, ptr, size*8, digest);
		if (err != LSH_SUCCESS)
			throw std::runtime_error("lsh512_digest failed");
	...
	printf("\n");
	printf("AlgorithmType: MessageDigest\n");
	printf("Name: LSH-512-256\n");
	printf("Source: gen_lsh512.cpp, https://github.com/noloader/cryptopp-test\n");
	alg = LSH_TYPE_512_256;
