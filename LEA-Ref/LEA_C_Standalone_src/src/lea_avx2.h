...
static void lea_encrypt_8block(unsigned char *ct, const unsigned char *pt, const LEA_KEY *key)
{
...
static void lea_decrypt_8block(unsigned char *pt, const unsigned char *ct, const LEA_KEY *key)
{
	__m256i x0, x1, x2, x3;
	__m128i tmp128;
